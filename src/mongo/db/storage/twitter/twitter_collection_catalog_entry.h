// Twitter_collection_catalog_entry.h
...
namespace mongo {
    ...
    class TwitterCollectionCatalogEntry : public CollectionCatalogEntry {
    public:
        TwitterCollectionCatalogEntry( TwitterEngine* engine, const StringData& ns );

        virtual ~TwitterCollectionCatalogEntry(){}
